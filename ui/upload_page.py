...
class UploadPage:
    ...
    def build(self, parent_window=None):  # ← FIXED
        ...
        info = Gtk.Label(label=(
            "\n Upload your files to your Proton Drive from your \n selected directory on your Computer User Home Directory\n"
            "\n Upload your files from your Documents folder on your \n machine to your Proton Drive Documents Folder \n"
        ))
        info.add_css_class("dim-label")
        container.append(info)

        # --- Button: Upload Documents ---
        btn_dcs = Gtk.Button(label="Upload from Directory: Documents")
        ...
        btn_pcs = Gtk.Button(label="Upload from Directory: Pictures")
        ...
        btn_dnld = Gtk.Button(label="Upload from Directory: Downloads")
